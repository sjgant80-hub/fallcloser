...
- Live: https://sjgant80-hub.github.io/fallcloser/
- Registry: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallcloser
- Publisher: [AI-Native Solutions](https://ai-nativesolutions.com)

## What this sovereign single-file browser tool does

fallcloser is a sovereign, MIT-licensed sovereign single-file browser tool in the AI-Native Solutions estate. It runs on your infrastructure, ships as source, and outlasts the vendor.

## Install

```
# Open https://sjgant80-hub.github.io/fallcloser/ in a modern browser
```
...
- Registry entry: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallcloser
